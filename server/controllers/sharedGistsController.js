...
export const getAllSharedGists = async (req, res) => {
  try {
...
// Share a gist
export const shareGist = async (req, res) => {
  try {
...
// Unshare a gist
export const unshareGist = async (req, res) => {
  try {
...
export const isGistShared = async (req, res) => {
  try {
    const { gistId } = req.params;
    const index = await getIndex();
...
export const getUserSharedGists = async (req, res) => {
  try {
    const userId = req.session.user?.id;
